...
'''=======================PID Controller=================================='''
        error_x = center[0] - img_width/2;
        error_y = center[1] - img_height/2;

        diff_error_x = error_x - old_error_x
        diff_error_y = error_y - old_error_y

        v_x = kI * error_x + kP * diff_error_x;
        v_y = kI * error_y + kP * diff_error_y;
